...
* [2. Web Service](#2-what-is-a-web-service)
* [3. API](#3-what-is-an-api)
* [4. REST](#4-what-is-rest)
* [5. Motivation Behind REST](#5-motivation-behind-rest)
* [6. REST Uses HTTP Methods](#6-rest-uses-http-methods)
* [7. REST Uses Existing Standards](#7-rest-uses-existing-standards)
* [8. Core Concepts of REST](#8-core-concepts-of-rest)
  * [8.1 Resource](#81-resource)
  * [8.2 URI](#82-uri-uniform-resource-identifier)
  * [8.3 Verbs (HTTP Methods)](#83-verbs-http-methods)
  * [8.4 Representation](#84-representation)
* [9. REST API Examples](#9-rest-api-examples)
  * [9.1 Get All Users](#91-get-all-users)
  * [9.2 Get Single User](#92-get-single-user)
  * [9.3 Create User](#93-create-user)
  * [9.4 Update Entire User](#94-update-entire-user)
  * [9.5 Update Only Last Name](#95-update-only-last-name)
  * [9.6 Delete User](#96-delete-user)
* [10. ASP.NET Core](#10-aspnet-core)
* [11. MVC (Model View Controller)](#11-mvc-model-view-controller)
  * [11.1 Model](#11-model)
  * [11.2 View](#12-view)
  * [11.3 Controller](#113-controller)
* [12. Repository Pattern](#12-repository-pattern)
* [13. Service Layer](#13-service-layer)
* [14. Repository vs Service](#14-repository-vs-service)
* [15. Dependency Injection (DI)](#15-dependency-injection-di)
* [16. Inversion of Control (IoC)](#16-inversion-of-control-ioc)
* [17. Mocking](#17-mocking)
* [18. Uploading Images to Firebase](#18-uploading-images-to-firebase)
* [19. Important Topics to Read](#19-important-topics-to-read)
  * [19.1 Cross-Origin Requests (CORS)](#191-cross-origin-requests-cors)
  * [19.2 Dapper](#192-dapper)
  * [19.3 Parameterized Query](#193-parameterized-query)
  * [19.4 Options Pattern](#194-options-pattern)
  * [19.5 Anonymous Type](#195-anonymous-type)
  * [19.6 Integration Testing](#196-integration-testing)
  * [19.7 JWT (JSON Web Token)](#197-jwt-json-web-token)
  * [19.8 API Versioning](#198-api-versioning)
* [20. Additional Reading (Optional)](#20-additional-reading-optional)
  * [20.1 GraphQL](#201-graphql)
  * [20.2 API Testing](#202-api-testing)
  * [20.3 BDD (Behavior Driven Development)](#203-bdd-behavior-driven-development)
* [21. Quick Interview Points](#21-quick-interview-points)
